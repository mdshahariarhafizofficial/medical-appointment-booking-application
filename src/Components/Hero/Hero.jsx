        ...
        <div className='md:px-14 pb-10'>
            <div className='bg-linear-to-t from-[white] to-[#0F0F0F1] text-center p-5 md:p-16 border-2 border-white rounded-3xl space-y-4'>
                ...
                <form onSubmit={(e)=> {
                    ...
                    }} className='md:max-w-[800px] mx-auto flex gap-6 flex-col md:flex-row'>
                    <input onChange={(e)=>setSearch(e.target.value)} defaultValue={search} required className='lg:w-[80%] md:w-[70%] h-13 bg-white rounded-full px-5 focus:outline-0 focus:shadow-xl' type="text" placeholder='Search any doctor...' />
                    <button type="submit" className="md:w-[30%] lg:w-[20%] h-13 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">Search Now</button>
                </form>
